## References
   ...
   - W3C
     - [W3](https://www.w3.org/)
     - [W3C GithubIO](https://w3c.github.io/)
     - [W3 Schools](https://www.w3schools.com)
     - [WhatWG Org](https://whatwg.org/)
   - Helpful
     - [What Web Can Do Today](https://whatwebcando.today/)
     - [Caniuse](https://caniuse.com/)
     - [30secondsofcode.org](https://github.com/30-seconds/30-seconds-of-code)
     ...
     - [FrontEnd Carrer](https://woliveiras.com.br/front-end-career)
     - [Mozilla Developmet Network](https://developer.mozilla.org/bm/docs/Web/JavaScript)
     - [Guia de Desenvolvimento Técnico - ThougtWorks](https://thoughtworksinc.github.io/guia-de-desenvolvimento-tecnico/)
   ...
   - Others
     ...
     - [CrockFord](https://www.crockford.com/)
     - [LibUV](https://github.com/libuv/libuv)
     - [Mathiasbynens](https://mathiasbynens.be/)
     - [RFC-Editor.org](https://www.rfc-editor.org/)
     - [Service Name and Transport Protocol Port Number Registry](https://www.iana.org/assignments/service-names-port-numbers/service-names-port-numbers.xml#Marty_Schoffstahl)
   - Books
   ...
   - GitHub
     ...
     - [OpenWC](https://github.com/open-wc)
     - [Web Developer Roadmap 2018](https://github.com/kamranahmedse/developer-roadmap)
     - [Awesome JavaScript](https://github.com/sorrycc/awesome-javascript)
     - [FrontEnd Challenges](https://github.com/LFeh/frontend-challenges)   
   - WebEngines
     - [V8 Engine](https://v8.dev/)
     - [Old IE - Trident](https://en.wikipedia.org/wiki/Trident_(software))
     - [Edge - EdgeHTML](https://docs.microsoft.com/en-us/microsoft-edge/dev-guide/whats-new)
     - [Firefox - Gecko](https://developer.mozilla.org/en-US/docs/Mozilla/Gecko)
     - [Safari Chrome Opera - WebKit](https://webkit.org/)
     - [Chromium Source Code](https://cs.chromium.org/chromium/src)
     - [Chrome Canary](https://www.google.com/intl/pt-BR/chrome/canary/) 
...
- IDEs
   - [VSCode](https://docs.microsoft.com/pt-br/visualstudio)
...
- Compiler JS Older Browsers
   - [Babel](https://babeljs.io/)
- Rain Song
   - [mynoise.net](https://mynoise.net/NoiseMachines/rainNoiseGenerator.php)
- Code Quality
...
- Chrome DevTools
   ...
   - [Segredos do Chrome DevTools - Zeno Rocha](https://www.youtube.com/playlist?list=PLiGzvgwA5Gmgnq5vPjJxW52hDiX3ndL53)
- Regex
